...
import com.lnyp.pswkeyboard.OnPasswordInputFinishText;
...
//密码输入框
    ...
    public void initPasswordInput(Activity context, OnPasswordInputFinishText onPasswordInputFinish) {
        mContext =  context;
        final OnPasswordInputFinishText onmyPasswordInputFinish = onPasswordInputFinish;

        pwdView.setOnFinishInput(new OnPasswordInputFinishText() {
            @Override
            public void inputFinishText(final String password) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mContext.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                onmyPasswordInputFinish.inputFinishText(password);
